...
<div class="legend">
    <div>(UoH G01) - G01, University of Huddersfield, signed entrance outside the Richard Steinitz Building</div>
    <div class="">(Phipps) - Phipps Hall, University of Huddersfield</div>
    <div class="">(Dai Hall) - Dai Hall, Victoria Ln, Huddersfield HD1 2QF</div>
    <div>(Atrium) - Atrium of the Richard Steinitz Building, University of Huddersfield</div>
</div>
<style lang='scss'>
    .blurb {
        font-size: 0.75rem;
